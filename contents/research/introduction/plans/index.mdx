...
- **Objective**: Fully unlocking the main menu and garage camera could open up new exploration possibilities. Check out our recent [Camera Movement Unlocked](https://pcw-bug-hunters.vercel.app/research/in-game-research/camera-movement-unlocked) post for more on what we’ve uncovered so far. Accessing these areas further could give us deeper insights into hidden game mechanics and interface elements.
...
- **Insight**: The garage area exists in the map data, situated beneath the firing range near the farthest target. In our [Main Menu Box Entry](https://pcw-bug-hunters.vercel.app/research/in-game-research/main-menu-box-entry), we managed to get close, but further research is needed to bridge this gap.
